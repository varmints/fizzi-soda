 ...
 */
export interface TextInCircleSliceDefaultPrimary {
  /**
   * Text in circle field in *Footer → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: text_in_circle.default.primary.text_in_circle
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  text_in_circle: prismic.KeyTextField;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type TextInCircleSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<TextInCircleSliceDefaultPrimary>,
  never
>;
 ...
 */
type TextInCircleSliceVariation = TextInCircleSliceDefault;

/**
 * Footer Shared Slice
 *
 * - **API ID**: `text_in_circle`
 * - **Description**: TextInCircle
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type TextInCircleSlice = prismic.SharedSlice<
  "text_in_circle",
  TextInCircleSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      SkyDiveSliceDefault,
      TextInCircleSlice,
      TextInCircleSliceDefaultPrimary,
      TextInCircleSliceVariation,
      TextInCircleSliceDefault,
    };
  }
}
